...
nitpick_ignore = [
    ...
    ("py:class", "PathLike"),
    ("py:class", "TomlData"),
    ("py:class", "BoxMeshSurface"),
    ("py:class", "CircleMeshSurface"),
    ("py:class", "CylinderMeshSurface"),
    ("py:class", "DiskMeshSurface"),
    ("py:class", "MeshSurface3D"),
    ("py:class", "PlaneWithCircleMeshSurface"),
    ("py:class", "RectangleMeshSurface"),
    ("py:class", "RenderItem"),
    ("py:class", "SphereMeshSurface"),
    ("py:class", "_type_"),
    ("py:class", "a_deg"),
    ("py:class", "array-like"),
    ("py:class", "b_deg"),
    ...
    ("py:class", "emout.Emout"),
    ("py:class", "emout.utils.InpFile"),
    ("py:class", "emout.utils.UnitTranslator"),
    ("py:class", "emout.utils.Units"),
    ("py:class", "generator"),
    ...
    ("py:attr", "skipped"),
    ("py:meth", "Data.plot"),
    ("py:meth", "Data.to_numpy"),
    ("py:meth", "MeshSurface3D.render"),
    ("py:meth", "_build_mesh"),
    ("py:meth", "_build_params"),
