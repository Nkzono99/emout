...
- `emout-pyvista-3d-visualization`: guidance for PyVista `plot3d()`, the deprecated `plot_pyvista()` compatibility alias, scalar/vector 3D views, boundary and trace overlays, saving, and HPC execution
